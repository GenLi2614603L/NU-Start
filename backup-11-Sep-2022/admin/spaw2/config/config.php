...
*/
SpawConfig::setStaticConfigItem('DOCUMENT_ROOT', '/homepages/19/d279173580/htdocs/admin/');
SpawConfig::setStaticConfigItem('SPAW_ROOT', '/homepages/19/d279173580/htdocs/admin/spaw2/');
SpawConfig::setStaticConfigItem('SPAW_DIR', '/admin/spaw2/');
/*
...
SpawConfig::setStaticConfigItem(
  ...
  array(
    array(
      'dir'     => SpawConfig::getStaticConfigValue('SPAW_DIR').'_img/',
